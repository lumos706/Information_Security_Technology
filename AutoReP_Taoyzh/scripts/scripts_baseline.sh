...
nohup python -u train_cifar.py --gpu 0 --arch resnet18 --w_lr 0.1 --mask_epochs 0 --epochs 400 --dataset cifar100 --optim cosine --act_type nn.ReLU > ./out/resnet18_cifar100_baseline.txt &
# ### Location of checkpoint file, log file, and tb for tensorboard file are in folder: 
# ### train_cifar/resnet9__cifar10/cosine_baseline_ReLUs0lr0.1ep400_baseline
...
#  --optim cosine --act_type nn.ReLU > ./out/resnet18_in_cifar100_basesline.txt &
...
# nohup python -u train_cifar.py --gpu 0 --arch resnet18 --w_lr 0.1 --mask_epochs 0 --epochs 400 --dataset tiny_imagenet --data_path "./tiny-imagenet-200" --optim cosine --act_type nn.ReLU > ./out/resnet18_tiny_imagenet_baseline.txt &
